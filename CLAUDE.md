...
- **CLI tools** → `home.packages` in `nix/home.nix` (ripgrep, fd, jq, fzf, gh, ghq, yq-go, zk, kubelogin, azure-cli, yarn, neovim, tmux, zsh-completions, podman, podman-compose, vfkit, lazysql, rainfrog, …).
